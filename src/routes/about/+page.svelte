<script lang="ts">
  ...
  const cc = {
    ...
    heroHeadline: "font-walsheim text-7xl font-extrabold uppercase !leading-[0.85] [font-size:min(12vw,13.5rem)] text-olkch-yellow -translate-y-[1.75cap] -mb-[1.25cap] flex flex-wrap [br]:w-full",
