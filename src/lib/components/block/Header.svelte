<script lang="ts">
  ...
  const tvHeader = tv({
    slots: {
      ...
      slotLogo:
        "transition duration-200 block fixed md:absolute left-fluid top-fluid md:left-0 md:top-0 md:bottom-0 rounded-full shadow isolote backdrop-blur bg-white/10 size-16 hover:scale-125 hover:rotate-3",
