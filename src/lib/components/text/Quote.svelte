  ...
  const tvQuote = tv({
    slots: {
      ...
      slotQuote: `
        ...
        after:absolute after:left-0 after:top-24 after:w-56 after:h-full after:bg-neutral-300 after:-translate-x-1/3 after:-z-10
      `,
      slotSource: "text-lg text-neon-green relative z-10",
