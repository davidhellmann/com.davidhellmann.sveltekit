<script lang="ts">
  ...
  const tvCardCV = tv({
    slots: {
      ...
      slotMeta:
        "flex items-center flex-wrap justify-center md:justify-start gap-x-4 text-olkch-green group-hover:text-neutral-950",
      slotLink: "text-olkch-green group-hover:text-neutral-950 underline font-mono text-sm"
    }
  });
