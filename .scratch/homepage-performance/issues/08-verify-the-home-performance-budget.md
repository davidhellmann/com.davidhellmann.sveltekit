...
**Status:** in-progress — awaiting staged deploy and public PageSpeed runs

- [x] Project checks pass and the homepage, photo archive, and a photo detail page receive focused regression checks.
...
- Pre-deploy findings, implementation details, and the exact post-deploy measurement protocol are recorded in
  `../assets/2026-08-05-ticket-08-pre-deploy.md`.
- The remaining acceptance checks require the updated build to be available on the public stage URL.
